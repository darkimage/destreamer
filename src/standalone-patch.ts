...
fs.copyFile = function copyFile(src: any, dest: any, flags: any, callback: any) {
...
fs.copyFileSync = function copyFileSync(src: any, dest: any, flags: any) {
  if (!isBundled(path.resolve(src))) {
